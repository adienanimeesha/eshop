...
public class PaymentServiceImplTest {
    ...
    @BeforeAll
    static void mocking() {
        UUID mockUUID = UUID.fromString("11111111-2222-3333-4444-555555555555");
    ...
    void setUp() {
        ...
        invalidVoucherData.put("voucherCode", "SHOPABC67890");
        ...
        paymentData2.put("referenceCode", "66666666-7777-8888-9999-000000000000");

        List<Product> products = new ArrayList<>();
        Product product1 = new Product();
        product1.setProductId("98765432-1234-5678-9012-345678901234");
        product1.setProductName("MIDI Controller");
        product1.setProductQuantity(1);
        products.add(product1);

        orders = new ArrayList<>();
        Order order1 = new Order(
                "55555555-6666-7777-8888-999999999999", products, 1234567890L, "Edward Kim");
        orders.add(order1);

        Order order2 = new Order("55555555-6666-7777-8888-999999999999", products, 1234567890L, "Edward Kim");
        orders.add(order2);
    }
    ...
    void CreatePaymentByVoucherCodeNullVoucher() {
        ...
        assertEquals("11111111-2222-3333-4444-555555555555", payment.getId());
    ...
    void CreatePaymentByBankTransferCorrect() {
        ...
        assertEquals("66666666-7777-8888-9999-000000000000", payment.getPaymentData().get("referenceCode"));
    ...
    void CreatePaymentByBankTransferNoBank() {
        ...
        paymentData.put("referenceCode", "77777777-8888-9999-0000-111111111111");
